...
public class SensorRepository implements IIoTRepository<Sensor> {
	...
	public SensorRepository(){
		this.add(new SensorEletricidade("255.255.255.255"));
		this.add(new SensorPessoa("255.255.255.255"));
		this.add(new SensorAmbiente("255.255.255.255"));
		this.add(new SensorVeiculo("255.255.255.255"));
	}
