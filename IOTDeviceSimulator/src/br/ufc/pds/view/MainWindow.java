...
public class MainWindow {
	...
	static IIoTRepository<Sensor> collection = ServiceInjector.provideSensorCollection();
	static ISensorViewFactory viewFactory = ServiceInjector.provideSensorViewFactory();
		...
		showButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if(selected == null){
					...
					viewFactory.createSensorView(selected);
			    }
			}
		});
