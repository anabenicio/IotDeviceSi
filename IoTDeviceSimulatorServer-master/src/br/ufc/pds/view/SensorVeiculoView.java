...
public class SensorVeiculoView extends SensorView {
	...
	public SensorVeiculoView(SensorVeiculo sensor) {
		...
		labelTemperaturaOleo = new JLabel("D", JLabel.NORTH);
		labelTemperaturaMotor = new JLabel("E", JLabel.NORTH_EAST);
		labelRpm = new JLabel("F", JLabel.NORTH_WEST);
		...
		JButton evAltaNivelGasolina = new JButton("Evento: Nível Gasolina Alta");
		JButton evBaixaNivelGasolina = new JButton("Evento: Nível Gasolina Baixa");
		...
		//----------------------------------------------------
		//Nível Óleo
		JButton evAltaNivelOleo = new JButton("Evento: Nível Óleo Alta");
		JButton evBaixaNivelOleo = new JButton("Evento: Nível Óleo Baixa");
		...
		JButton evAltaTemperaturaMotor = new JButton("Evento: Temperatura Motor Alta");
		JButton evBaixaTemperaturaMotor = new JButton("Evento: Temperatura Motor Baixa");
		...
		Thread thread = new Thread(){
		    public void run(){
		    	while(true){
		    		...
		    		labelNivelGasolina.setText("Tensão: "+ String.valueOf(sensor.getNivel_gasolina()));
		    		labelNivelOleo.setText("Corrente: "+ String.valueOf(sensor.getNivel_oleo()));
		    		labelRpm.setText("Consumo: "+ String.valueOf(sensor.getRpm()));
		    		labelTemperaturaMotor.setText("Consumo: "+ String.valueOf(sensor.getTemp_motor()));
		    		labelTemperaturaOleo.setText("Consumo: "+ String.valueOf(sensor.getTemp_oleo()));
		    		labelVelocidade.setText("Consumo: "+ String.valueOf(sensor.getVelocidade()));
